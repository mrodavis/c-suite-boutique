...
export default function AboutContent() {
  return (
    <main className="bg-[#0e0f11] text-white min-h-screen overflow-hidden">
      ...
      {/* 🌟 Hero Section */}
      <section className="relative py-28 md:py-36 bg-[radial-gradient(circle_at_top,_rgba(20,150,140,0.25),_transparent_70%)] text-center overflow-hidden">
        {/* Background Logo */}
...
{/* ✨ Mission + Philosophy */}
<section className="pt-10 md:pt-12 pb-4 container mx-auto px-6 md:px-10">
...
{/* 🌿 Founder Story */}
<section className="mt-[-3rem] md:mt-[-5rem] py-16 md:py-20 bg-gradient-to-b from-charcoal/40 to-[#0e0f11] relative z-10">
  <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-10">
    ...
    >
      ...
      {/* 💫 Call to Action */}
      <section className="py-20 md:py-24 bg-gradient-to-r from-teal-900/30 via-charcoal to-teal-800/30 text-center">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
