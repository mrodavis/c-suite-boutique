      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
          ...
          >
            ...
            >
              <Image
                src="/images/founder-cynthia.png"
                alt="Cynthia Davis, Founder & CEO of C-Suite Beauty Boutique"
                fill
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to top,rgba(44,32,32,0.25) 0%,transparent 60%)",
                }}
              />
            </div>
          </motion.div>
